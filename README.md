...
> **2FA-Vault** is a personal fork of an upstream self-hosted OTP vault — a web app to manage Two-Factor Authentication (2FA) accounts and generate OTP codes. This fork is a work in progress and experiments with multi-user, team sharing, and end-to-end encryption on top of the upstream project. It is not an official upstream release.

## Relationship to upstream

2FA-Vault forks the full upstream ecosystem. All credit for the original design and implementation goes to [Bubka](https://github.com/Bubka) and the upstream contributors.

The fork repositories are maintained under the `TranAnSE/2FA-Vault*` namespace.
...
For production deployment, the [2FA-Vault install docs](https://docs.2fa-vault.app/getting-started/installation/) are still largely applicable because this fork has not diverged heavily in deployment model.
...
- [Migration from 2FA-Vault](docs/guides/migration-from-2fauth.md)

These describe the *intended* design of the fork; sections may be ahead of the code.

## Contributing

This is primarily a personal fork. Issues and PRs specific to fork-only features such as E2EE, multi-user behavior, and teams are welcome here.

## License

[AGPL-3.0](https://www.gnu.org/licenses/agpl-3.0.html) — same as the upstream project.

## Acknowledgments

- Bubka and the upstream contributors — this fork would not exist without your work.
