...
<br/><br/>
**<?php echo app('translator')->get('message.notifications.new_device.resume'); ?>**<br/>
<?php echo app('translator')->get('message.notifications.new_device.connection_details'); ?>:
...
<?php echo app('translator')->get('message.notifications.new_device.recommandations'); ?><br/>

<?php echo app('translator')->get('message.notifications.regards'); ?>,<br/>
<?php echo e(config('app.name')); ?>

<?php echo $__env->renderComponent(); ?>
<?php /**PATH /srv/resources/views/emails/signedInWithNewDevice.blade.php ENDPATH**/ ?>