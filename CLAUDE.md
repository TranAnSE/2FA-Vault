...
### 📚 Documentation Hub
**[docs/README.md](docs/README.md)** — Central hub for all documentation with role-based quick links

### Core Documentation (Read First)
| Category | Purpose |
|----------|---------|
| **[docs/architecture/](docs/architecture/)** | System design, codebase structure, technical decisions |
| **[docs/development/](docs/development/)** | Code standards, conventions, security guidelines |
| **[docs/guides/](docs/guides/)** | Setup, migration, contribution guides |
| **[docs/reference/](docs/reference/)** | Roadmap, changelog, project planning |

### Key Documents
- [docs/architecture/system-architecture.md](docs/architecture/system-architecture.md) — Layered architecture, data flows, encryption
- [docs/architecture/codebase-summary.md](docs/architecture/codebase-summary.md) — File structure, services, stores, key files
...
This project is indexed by GitNexus as **2FA-Vault** (4671 symbols, 12386 relationships, 202 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
