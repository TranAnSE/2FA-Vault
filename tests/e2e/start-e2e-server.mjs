...
// --no-interaction, so use our non-interactive artisan command instead.
runCommand('php artisan passport:create-personal-client --name="E2E Personal Access Client" --env=e2e --no-interaction', 'passport:client');
