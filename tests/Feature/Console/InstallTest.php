...
class InstallTest extends FeatureTestCase
{
    ...
    const PASSPORT_CREATE_CLIENTS_CONFIRMATION = 'Would you like to create the "personal access" grant client?';
    ...
    public function test_install_completes()
    {
        $this->artisan('2fauth:install')
            ...
            // Passport v13 runs silently under 2fauth:install (the personal
            // access client is now created explicitly by the install command),
            // so no passport confirmations surface at this level.
            ->assertSuccessful();
    }
